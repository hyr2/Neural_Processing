function [mask,xi,yi] = defineArea(SC,r)
...
figure('Name', 'Define the activation area (Press ESC to skip)', 'NumberTitle', 'off','WindowState','maximized');
[mask,xi,yi] = roipoly(mat2gray(SC, r));
close(gcf);
