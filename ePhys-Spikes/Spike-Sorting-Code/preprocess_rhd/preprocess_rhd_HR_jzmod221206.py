...
# given a session
Raw_dir  = '/media/hanlin/Liuyang_10T_backup/jiaaoZ/128ch/spikeSorting128chHaad/data/BC6/11-11-2021'
SESSION_REL_PATH = Raw_dir.split('/')[-1]
output_dir  = '/media/hanlin/Liuyang_10T_backup/jiaaoZ/128ch/spikeSorting128chHaad/spikesort_out221206/'
