...
from load_intan_rhd_format.load_intan_rhd_format_YJ import read_data_YJ, read_header, get_n_samples_in_data_YJ
...
# given a session
DATA_ROOTPATH  = "/media/luanlab/DATA/SpikeSorting/RawData"
MDA_ROOTPATH   = "/media/luanlab/Data_Processing/Jim-Zhang/Spike-Sort/converted/data_mda/Yifu"
GEOM_ROOTPATH  = "/media/luanlab/DATA/SpikeSorting/SpikeSortOut"
ANIMAL_REL_PATH = "2021-01-04-aged"

ANIMAL_FOLDER_RAW=os.path.join(DATA_ROOTPATH, ANIMAL_REL_PATH)

for SESSION_REL_PATH in os.listdir(ANIMAL_FOLDER_RAW):
    if SESSION_REL_PATH.startswith("2"):


        SESSION_FOLDER_RAW = os.path.join(DATA_ROOTPATH, ANIMAL_REL_PATH,SESSION_REL_PATH)
        SESSION_FOLDER_MDA = os.path.join(MDA_ROOTPATH, ANIMAL_REL_PATH,SESSION_REL_PATH)
        SESSION_FOLDER_CSV = os.path.join(GEOM_ROOTPATH, ANIMAL_REL_PATH,SESSION_REL_PATH)
        ...
        for filename in filenames:
            n_ch, n_samples_this_file =get_n_samples_in_data_YJ(os.path.join(SESSION_FOLDER_RAW, filename))
        ...
        for i_file, filename in enumerate(filenames):
            ...
            data_dict = read_data_YJ(os.path.join(SESSION_FOLDER_RAW, filename))
